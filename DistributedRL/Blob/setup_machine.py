...
with open('C:/prereq/log.txt', 'w') as f:
    ...
    do_command('echo {"SettingsVersion": 1.0, "SimMode": "Car"} > D:\\Users\\explorationrl\\Documents\\AirSim\\settings.json')
    do_command('call C:\\prereq\\mount.bat')
    ...
    do_command('schtasks.exe /create /xml Z:\\scripts_downpour\\run_airsim_on_user_login.xml /RU explorationrl /RP erl3232 /tn StartAirsimIfAgent /IT')