...
parser.add_argument('--recordings_dir', '-recordings_dir', help='path to raw data folder', default='C:\\Users\\t-dezado\\OneDrive - Microsoft\\Documents\\AirSim\\shifted_l2.0', type=str)
