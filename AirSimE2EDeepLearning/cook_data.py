...
parser.add_argument('--data_dir', '-data_dir', help='path to raw data folder', default='C:\\Users\\t-dezado\\OneDrive - Microsoft\\Documents\\AirSim', type=str)
...
Cooking.cook(data_folders, args.output_dir, args.buffer_size, args.img_type, train_test_split)