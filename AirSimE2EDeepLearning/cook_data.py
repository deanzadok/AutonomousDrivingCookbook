...
parser.add_argument('--data_dir', '-data_dir', help='path to raw data folder', default='C:\\Users\\t-dezado\\OneDrive - Microsoft\\Documents\\Data\\imitation_to_segmentation_4images', type=str)
parser.add_argument('--output_dir', '-output_dir', help='path to destination folder', default='C:\\Users\\t-dezado\\OneDrive - Microsoft\\Documents\\Data\\cooked_data\\imitation_to_segmentation_4images_28', type=str)
